...
public class GeminiManager {
    ...
    public void sendImageAndText(Bitmap bitmap, String promptStr, Context context, GeminiCallback callback) {
        ...
        send(promptStr, bitmap != null ? java.util.Collections.singletonList(bitmap) : null, null, null, context, callback);
        Log.d(TAG, "sendImageAndText: done");
    }

    public void sendImagesAndText(List<Bitmap> bitmaps, String promptStr, Context context, GeminiCallback callback) {
        Log.d(TAG, "sendImagesAndText: start");
        send(promptStr, bitmaps, null, null, context, callback);
        Log.d(TAG, "sendImagesAndText: done");
    }
    ...
    private void send(String promptStr, List<Bitmap> bitmaps, byte[] bytes, String mimeType, Context context, GeminiCallback callback) {
